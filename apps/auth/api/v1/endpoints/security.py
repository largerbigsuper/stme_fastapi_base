...
def login_for_access_token(
    ...
    return services.security.login(db, form_data)
...
def password_change(payload: schemas.UserPasswordChange, 
    ...
    return services.security.password_change(db, current_user, payload)
...
def password_reset(payload: schemas.UserPasswordReset, db: Session = Depends(get_db)):
    ...
    return services.security.password_reset(db, payload)
